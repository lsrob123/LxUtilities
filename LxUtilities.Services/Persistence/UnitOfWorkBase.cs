...
namespace LxUtilities.Services.Persistence
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        ///     Abstract method to be implemented for persisting all changes within the scope. It can be implemented with empty
        ///     action if it is not required by the backing data store
        /// </summary>
